export function EarIcon() {
  return (
    <svg viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" aria-hidden>
      <path d="M9 12c0-4 3.2-7.5 7.2-7.5S23.4 8 23.4 12v5.2c0 2.4 1.4 3.8 3.1 3.8H7.6C5.9 21 4.6 19.6 4.6 17.2V12" />
      <path d="M11.2 21.4c.8 3 3.1 4.8 5 4.8s4.2-1.8 5-4.8" />
    </svg>
  );
}
...
export function ScreenIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" aria-hidden>
      ...
      <path d="M16.2 8.2a5 5 0 0 1 0 7.6" />
...
export function PlayIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="currentColor" aria-hidden>
      <path d="M4 2.6v8.8l8-4.4-8-4.4z" />
    </svg>
  );
}
...
export function PauseIcon() {
  return <svg width="14" height="14" viewBox="0 0 14 14" fill="currentColor" aria-hidden>
